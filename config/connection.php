...
// SQL Query
$sql = "INSERT IGNORE INTO  parents(id,name,email,password,phone,dob,image,address,spouse,occupation,gender,document_type,document_path,document_number,otp,otp_expiry,is_verified,created_at) 
        VALUES ('1','sita','sita@gmail.com','$hashed_password','9804000857','2004-07-23','Babysafe/uploads/images/parents/sitap.jpg','brt','ram','doctor','1','citizenship','Babysafe/uploads/documents/parents/citizenship.jpg','06099866572','5555',DATE_ADD(NOW(), INTERVAL 5 MINUTE),0,NOW())";
...
// SQL Query
$sql = "INSERT IGNORE INTO  sitters(id,name,email,password,phone,dob,image,address,spouse,bio,gender,document_type,document_path,document_number,otp,otp_expiry,is_available,background_status,is_verified,created_at) 
        VALUES ('1','ivy','ivy@gmail.com','$hashed_password','9804000857','2004-07-23','Babysafe/uploads/images/sitters/ivyp.jpg','brt','shyam','Hi, I am  Ivy, a reliable and fun-loving babysitter with 1+ years of experience caring for kids from infants to 10-year-olds.','1','citizenship','Babysafe/uploads/documents/sitters/ivy.jpg','06099866872','5555',DATE_ADD(NOW(), INTERVAL 5 MINUTE),'2','0',0,NOW())";
